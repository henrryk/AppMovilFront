...
import { NavController, NavParams, AlertController, MenuController, Events, LoadingController } from 'ionic-angular';
...
export class SiniestroPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public connectivityService: ConnectivityService,
    public alertCtrl: AlertController, public vars: GlovalVars, public auth: AuthService,
    public menu: MenuController, private events: Events, private loadingCtrl: LoadingController) {
    this.loadGoogleMaps();
